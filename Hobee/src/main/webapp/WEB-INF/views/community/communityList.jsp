					...
					<div class="swiper-wrapper">
                        ...
                        : pageContext.request.contextPath += '/resources/img/common/default-profile.png'}" />
								...
								<div class="hot-content">
									<div class="hot-tag">${ht.category_name}· 실시간 인기</div>
            ...
            ====================================================== --%>
				...
				<div class="category-chips">
					...
					<a href="${pageContext.request.contextPath}/community/list"
						...
						전체 </a> <a
						href="${pageContext.request.contextPath}/community/list?category_id=1"
						class="chip ${cri.category_id == 1 ? 'active' : ''}">공지</a> <a
						href="${pageContext.request.contextPath}/community/list?category_id=2"
						class="chip ${cri.category_id == 2 ? 'active' : ''}">잡담</a> <a
						href="${pageContext.request.contextPath}/community/list?category_id=3"
						class="chip ${cri.category_id == 3 ? 'active' : ''}">Q&A</a> <a
						href="${pageContext.request.contextPath}/community/list?category_id=4"
						class="chip ${cri.category_id == 4 ? 'active' : ''}">후기</a>

					<c:forEach var="cm" items="${categoryMainList}">
						<a
							href="${pageContext.request.contextPath}/community/list?category_main_num=${cm.category_main_num}"
